...
This repository contains all the steps necessary to reproduce the analyses done in [Grillova *et al*., 2019 Frontiers in Microbiology](https://www.frontiersin.org/articles/10.3389/fmicb.2019.01691/full) **Directly Sequenced Genomes of Contemporary Strains of Syphilis Reveal Recombination-Driven Diversity in Genes Encoding Predicted Surface-Exposed Antigens** publication. 
